...
int main() {
    ...
    std::cout << "Welcome to Mini Database Manager 2.1!";
    ...
    while (stay_in_the_program == true) {
        ...
        if (userchoice == 1) {
            ...
            if (database.size() == 0) {
                ...
                //check that the user doesn´t attempt to modify an index out of the database's reach
                if (index < database.size()) {
                    ...
                    std::cout << "The last index in the database is " << database.size() - 1 << ". Please enter an integer smaller than or equal to " << database.size() - 1 << " or enlargen the database.";
            ...
            if (index < database.size()) {
                ...
                std::cout << "The last index in the database is " << database.size() - 1 << ". Please enter an integer smaller than or equal to " << database.size() - 1 << ".";
